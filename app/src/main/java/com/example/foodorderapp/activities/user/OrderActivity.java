...
import java.util.List;
    ...
    public class OrderActivity extends AppCompatActivity implements HistoryListener , DetailHistoryListener {
    ...
    public void evaluationClick(String idfood) {
        ...
        RateUsDialog rateUsDialog = new RateUsDialog(this , idfood ,iduser);
